...
#ifndef DEFAULT_OT_TUNNEL_IN_GPIO
  #define DEFAULT_OT_TUNNEL_IN_GPIO GPIO_IS_NOT_CONFIGURED
#endif

#ifndef DEFAULT_OT_TUNNEL_OUT_GPIO
  #define DEFAULT_OT_TUNNEL_OUT_GPIO GPIO_IS_NOT_CONFIGURED
#endif
